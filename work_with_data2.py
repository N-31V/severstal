...
class SteelDataset(Dataset):
    def __init__(self, data_folder, df):
        self.df = df
...
def train_val_dataloader(batch_size, num_workers):
    train_df = pd.read_csv('input/train_df.csv', index_col='img')
    val_df = pd.read_csv('input/val_df.csv', index_col='img')
